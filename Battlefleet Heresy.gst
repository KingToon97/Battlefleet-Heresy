...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="86405571-5289-597b-b308-a9a2d68c00b9" name="Battlefleet Heresy" revision="34" battleScribeVersion="2.03" authorName="Battlefleet Heresy Community Data" authorContact="" authorUrl="">
 ...
 <sharedRules>
  ...
  <rule id="7c9d3b45-ec00-5fca-a050-b3dd28987708" name="Keyword: Critical Damage" hidden="false">
   <description>Fires and breaches. A ship is either burning or it is not: &lt;b&gt;Critical Damage does not stack&lt;/b&gt;. At the end of each battle round a burning ship loses 1 Crew, with no roll. It is no longer inflicted by the Damage Table — only weapons and rules that name it, such as Phosphex Shell Magazines, cause it. Mark it with a single token.</description>
  </rule>
  ...
  <rule id="53724fbb-9c1d-536e-a6d9-551c39f36bcf" name="Keyword: Melta Mines" hidden="false">
   <description>The Falchion-class Frigate carries &lt;b&gt;one&lt;/b&gt; Melta Mine; no other ship has them, and it is &lt;b&gt;One Use&lt;/b&gt; — once laid it is gone for the battle whether it detonates or not. • &lt;b&gt;Laying:&lt;/b&gt; in the Movement step, after the ship has moved and instead of shooting, place the mine on a 32mm base touching the ship's base. Never within 6″ of an enemy ship. • &lt;b&gt;Triggering:&lt;/b&gt; a mine detonates the moment any part of a ship's base passes over it. Frigates of either fleet pass safely, and aircraft ignore mines entirely. • &lt;b&gt;Blast:&lt;/b&gt; every ship within 3″ — friend, foe, and the ship that triggered it — suffers one hit at Strength 9, AP 1, Armourbane, against the facing nearest the mine. Mines ignore Void Shields. Remove the marker once the blast is resolved. • &lt;b&gt;Daisy chain:&lt;/b&gt; any other mine within 3″ of a detonating mine is triggered automatically and detonates in turn, whoever laid it, and may in turn set off a third. Resolve each blast separately and in order, from the first mine outward. A ship caught by several blasts is hit by each of them. This is why minefields are laid loose, and why a careless line of them will take a squadron apart.</description>
  </rule>
