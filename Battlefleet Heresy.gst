...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="86405571-5289-597b-b308-a9a2d68c00b9" name="Battlefleet Heresy" revision="74" battleScribeVersion="2.03" authorName="Battlefleet Heresy Community Data" authorContact="" authorUrl="">
 <costTypes>
 ...
 <categoryEntries>
  ...
  <categoryEntry id="56a4df28-b35e-5a06-9b58-8989d9709b5f" name="Defence Station" hidden="false" />
  <categoryEntry id="8a3312a4-3776-5054-88be-22c3337908da" name="Line Credit" hidden="false" />
 </categoryEntries>
 <forceEntries>
  <forceEntry id="6190d752-db79-5076-8b85-3025cae9911c" name="Fleet" hidden="false">
   <categoryLinks>
    ...
    <categoryLink id="e471c89c-25c1-5900-b9e6-7076337096d1" name="Capital" hidden="false" targetId="bd422ebf-10b3-5085-89cc-263568c40fe0" primary="false">
     <modifiers>
      <modifier type="increment" field="bff85e27-4383-5baf-a2e5-1e7915aebf46" value="1.0">
       <repeats>
        <repeat field="selections" scope="force" childId="8a3312a4-3776-5054-88be-22c3337908da" shared="true" roundUp="false" value="4.0" repeats="1" includeChildSelections="true" includeChildForces="false" />
       </repeats>
      </modifier>
     </modifiers>
     <constraints>
    ...
    <categoryLink id="52a7481f-8196-5286-bd59-3577726350c4" name="Defence Station" hidden="false" targetId="56a4df28-b35e-5a06-9b58-8989d9709b5f" primary="false" />
 ...
 <sharedRules>
  ...
  <rule id="05ae4944-6daa-593c-ab8c-235a2cf6a82b" name="Keyword: Armourbane" hidden="false">
   <description>&lt;b&gt;Every hit from an Armourbane weapon that penetrates rolls on the Damage Table&lt;/b&gt;, whatever the die showed — it does not need the natural 6 that governs every other weapon. Apply the weapon's AP modifier to that roll as normal. • Armourbane gives &lt;b&gt;no bonus to the Armour Penetration roll&lt;/b&gt;: the roll remains 1D6 + Strength against the target's Armour Value. • An AP D weapon with Armourbane is Reactor Struck as usual and still does not roll on the table. • Armourbane is stated on the weapon or granted by a rule; no weapon gains it from range alone.</description>
  </rule>
  ...
  <rule id="74145fd7-84df-5d17-8261-bab70c919268" name="Ship Damage Table" hidden="false">
   <description>Rolled when a hit penetrates on a &lt;b&gt;natural 6&lt;/b&gt;, and on &lt;b&gt;every&lt;/b&gt; penetrating hit from an &lt;b&gt;Armourbane&lt;/b&gt; weapon. Modifiers: &lt;b&gt;AP 1&lt;/b&gt; +1 • &lt;b&gt;AP 2&lt;/b&gt; +2 • Ramming +1 • Battleship target −1. A modified 7+ counts as Reactor Struck; below 1 counts as 1. An AP D weapon does not roll here — any hit of its that penetrates is Reactor Struck. &lt;b&gt;1 NO EFFECT&lt;/b&gt; • Nothing happens. &lt;b&gt;2 HULL BREACH&lt;/b&gt; • The ship loses 1 Crew. &lt;b&gt;3 CREW SHAKEN&lt;/b&gt; • The ship fires Snap Shots for the rest of this battle round. &lt;b&gt;4 IMMOBILISED&lt;/b&gt; • The ship becomes Immobilised. &lt;b&gt;5 MAGAZINE EXPLOSION&lt;/b&gt; • The ship loses &lt;b&gt;2 Hull Points and 2 Crew&lt;/b&gt;. &lt;b&gt;6 REACTOR STRUCK&lt;/b&gt; • Any ship below Gloriana class loses &lt;b&gt;D6&lt;/b&gt; Hull Points; a Gloriana, the Abyss or the Phalanx loses &lt;b&gt;D3&lt;/b&gt;. If that loss takes the ship to 0 Hull Points it suffers a Catastrophic Explosion automatically, with no roll and no chance of becoming a wreck. Nothing on this table persists beyond the round except Immobilised.</description>
  </rule>
  ...
  <rule id="50b28045-2fda-5e3c-a663-5a2b3b4a9259" name="Shooting" hidden="false">
   <description>A ship fires everything that bears at one enemy ship; it may split its fire at a cost, for which see Splitting Fire. Roll a D6 per shot: &lt;b&gt;the shot hits on the ship's Ballistic Skill or better&lt;/b&gt;. BS is the number you need — a ship with &lt;b&gt;BS 4&lt;/b&gt; hits on a &lt;b&gt;4+&lt;/b&gt;. • &lt;b&gt;Improving BS lowers the number&lt;/b&gt;: a +1 Ballistic Skill bonus takes BS 4 to BS 3, hitting on 3+. A penalty raises it. • A natural 1 always misses, and no modifier may improve a ship beyond &lt;b&gt;BS 2&lt;/b&gt;. • BS penalties from different sources are cumulative to a maximum of +2 to the number required. • Modifiers: target is a wreck, improve BS by 1 — a hulk cannot dodge. A ship that held station fires its Port and Starboard broadsides at &lt;b&gt;+1 BS&lt;/b&gt;.</description>
  </rule>
  ...
  <rule id="b00e13cb-eb88-50c1-b468-fd81d592e0c0" name="Universal Ship Upgrades" hidden="false">
   <description>Open to every ship below Gloriana class, whatever its Legion or role. Glorianas, the Abyss and the Phalanx may not take them. Each may be bought once per ship, in any combination. Each costs a share of the ship's own points, rounded to the nearest 5: • Astartes Crew 20% — every Crew point aboard counts as Legiones Astartes (+1). Not available to hulls that already have it. • Veteran Crew 25% — +1 BS, improving to a minimum of BS 2. • Adamantium Belt Armour 20% — +1 Side Armour, to a maximum of AV 14, and −2″ Speed to a minimum of 4″. • Plasma Drive Overhaul 12% — +2″ Speed. • Emergency Shield Capacitors 10% — +1 to Void Shield regeneration rolls. • Phosphex Shell Magazines 8% + 20 pts — a penetrating hit from any Heavy Macro-Cannon Battery aboard also kills 1 Crew. • Blast-Shielded Magazines 8% — a Magazine Explosion costs this ship 1 less Hull Point and 1 less Crew, each to a minimum of 0. Triple Lance Turret and Quad Warp Lance Turret ships only.</description>
  </rule>
  <rule id="0591ff9a-8270-5c08-8d3e-0615e5b1fc75" name="Veteran Crew and Accuracy" hidden="false">
   <description>Any ship may take a Veteran Crew once: &lt;b&gt;+1 Ballistic Skill&lt;/b&gt; for the battle, which lowers the number it needs to hit by one. It costs 25% of the ship's own points value, rounded to the nearest 5. &lt;b&gt;Accuracy bonuses stack freely — position, command, Fleet Orders, traits and paid upgrades all add together. The only ceiling is that no ship improves beyond BS 2.&lt;/b&gt; For commanders, see Characters &amp;amp; Primarchs.</description>
  </rule>
  ...
  <rule id="6d4d5a18-1a2c-5915-be2b-7e3ff4fdccca" name="State: Immobilised" hidden="false">
   <description>Speed 0: the ship may not move and may not turn. It shoots and is shot at normally, may not Evade, and drifts nowhere — it simply stops. A &lt;b&gt;Repair Engine&lt;/b&gt; Fleet Order clears it on a &lt;b&gt;3+&lt;/b&gt;. Immobilised does not stack; a ship already Immobilised that would become so again is unaffected.</description>
  </rule>
  ...
  <rule id="a6010b43-17e5-5331-a2e7-697687c6c80c" name="Break Away" hidden="false">
   <description>Two different things use this name and both work the same way. • &lt;b&gt;Breaking a ram-lock&lt;/b&gt;: a &lt;b&gt;Locked&lt;/b&gt; ship may Break Away when it would move, once each per battle round. Roll a D6; on &lt;b&gt;5+&lt;/b&gt; it disengages 1″ away. See State: Locked. • &lt;b&gt;Breaking off a boarding action&lt;/b&gt;: at the start of any exchange after the first, the &lt;b&gt;defending&lt;/b&gt; ship may attempt to throw the boarders off. Roll a D6; on &lt;b&gt;5+&lt;/b&gt; the boarding action ends at once and every surviving Boarding Party returns to its own ship. The attacker never Breaks Away — boarders withdraw freely at the start of any exchange, which needs no roll. • A natural 1 always fails, and modifiers from several sources are cumulative.</description>
  </rule>
 </sharedRules>
</gameSystem>