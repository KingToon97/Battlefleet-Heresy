...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="86405571-5289-597b-b308-a9a2d68c00b9" name="Battlefleet Heresy" revision="44" battleScribeVersion="2.03" authorName="Battlefleet Heresy Community Data" authorContact="" authorUrl="">
 ...
 <sharedRules>
  ...
  <rule id="84ae4fff-db0c-5d03-88d0-5a974e478c6a" name="Keyword: Caestus Assault Ram" hidden="false">
   <description>The Caestus Assault Ram is a boarding craft, not a gunship: bought into a Launch Bay for 60 pts, Armour 10, Speed 20″. It carries 4 Crew of boarders rather than 1, and its magna-melta bore opens the hull directly — boarders it delivers ignore the −1 for a Hull Assault and land as though delivered by craft. It may not be fired on by Overwatch on the round it strikes.</description>
  </rule>
