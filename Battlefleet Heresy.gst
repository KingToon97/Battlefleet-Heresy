...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="86405571-5289-597b-b308-a9a2d68c00b9" name="Battlefleet Heresy" revision="67" battleScribeVersion="2.03" authorName="Battlefleet Heresy Community Data" authorContact="" authorUrl="">
 <costTypes>
 ...
 <sharedRules>
  ...
  <rule id="d34ecc22-1164-5127-b7e2-8920923aba83" name="Point-Blank Broadsides" hidden="false">
   <description>At 6″ or less, Port, Starboard and Dorsal weapons fire at +1 BS. Prow weapons gain nothing. Accuracy bonuses stack freely; the only ceiling is that &lt;b&gt;no ship exceeds BS 5&lt;/b&gt;.</description>
  </rule>
  ...
  <rule id="0591ff9a-8270-5c08-8d3e-0615e5b1fc75" name="Veteran Crew and Accuracy" hidden="false">
   <description>Any ship may take a Veteran Crew once: +1 Ballistic Skill for the battle. It costs 25% of the ship's own points value, rounded to the nearest 5. &lt;b&gt;Accuracy bonuses stack freely — position, command, Fleet Orders, traits and paid upgrades all add together. The only ceiling is that no ship exceeds BS 5.&lt;/b&gt; For commanders, see Characters &amp;amp; Primarchs.</description>
  </rule>
